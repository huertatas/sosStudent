...
const Login = ({ navigation }) => {
  ...
  return (
    <Container>
      ...
      <Input placeholder='Email...' autoComplete={true} autoCapitalize="none" onChangeValue={setEmail} />
      <Input
      ...
      />
      <ButtonView>
      <Submit title='Login' onPress={handleSubmit}><ButtonText>Login</ButtonText>
      </Submit>
      </ButtonView>
    </Container>
  )
